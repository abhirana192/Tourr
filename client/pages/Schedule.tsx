              ...
              <table className="border-collapse w-max min-w-full">
                <thead>
                  <tr className="bg-gray-100 border-b border-gray-400 sticky top-0 z-30">
                    <th className="px-1 py-1 text-left text-[10px] font-bold text-gray-700 bg-yellow-100 border-r border-gray-400 min-w-16 whitespace-nowrap sticky left-0 top-0 z-20">DATE</th>
